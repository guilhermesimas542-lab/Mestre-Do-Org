"use client";
/* LP Mestre do Orgasmo — Upsell 2 (cópia independente do /upsell) */
...
export default function Upsell2Page() {
  ...
  const handleCheckout = () =>
    void openCheckoutWithTracking(CHECKOUT_URL, "upsell2", 156);
    ...
    <main className="w-[390px] bg-black text-white">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="relative flex flex-col items-center px-[19.5px] pb-10 max-w-[390px] mx-auto">
          ...
          {/* CTAs */}
          <div className="mt-8 flex flex-col items-center gap-[17px] w-full px-6">
