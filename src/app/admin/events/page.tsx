  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-neutral-400">
        Últimos {eventos.length} eventos. Linhas em vermelho ={" "}
        <strong className="text-red-400">TrackingError</strong> (falha em algum passo do tracking).
      </p>
            ...
            {eventos.map((e) => (
              <tr
                ...
                className={`border-t border-neutral-700 ${
                  e.eventType === "TrackingError" ? "bg-red-950/30" : ""
                }`}
              >
